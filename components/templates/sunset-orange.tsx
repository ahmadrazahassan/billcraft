// Sunset Orange - Warm Bold Energy
import React from 'react'
import { InvoiceData, CurrencyDisplay, TemplateLogo } from './template-utils'

export const SunsetOrange: React.FC<{ data: InvoiceData }> = ({ data }) => {
  return (
    <div className="w-full h-full bg-white p-16 font-sans" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      <div className="flex justify-between items-start mb-12 pb-6 border-b-4 border-orange-500">
        <div>
        ...
        <div className="text-right">
          <h2 className="text-4xl font-black text-orange-600">INVOICE</h2>
      ...
      <div className="mb-12 p-6 bg-orange-50 rounded-xl border-l-4 border-orange-600">
        <p className="text-xs uppercase tracking-wider text-orange-700 font-bold mb-2">Bill To</p>
      ...
      <div className="flex justify-end mb-12">
        <div className="w-80">
          ...
          <div className="flex justify-between py-4 text-xl font-black bg-orange-600 text-white px-4 rounded-lg mt-2">
            <span>TOTAL</span>
      ...
      {data.notes && <div className="mb-6 p-4 bg-orange-50 rounded-lg"><p className="text-xs uppercase tracking-wider text-orange-700 mb-1">Notes</p><p className="text-sm text-gray-700">{data.notes}</p></div>}
      {data.terms && <div className="p-4 bg-orange-50 rounded-lg"><p className="text-xs uppercase tracking-wider text-orange-700 mb-1">Terms</p><p className="text-sm text-gray-700">{data.terms}</p></div>}
    </div>
  )
}
