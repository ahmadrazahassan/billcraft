  ...
  return (
    <div className="bg-white p-12 max-w-4xl mx-auto">
      ...
      <div className="flex items-start justify-between mb-16">
        <div>
          <h1 className="text-2xl font-light text-slate-900 mb-8">{data.company.name}</h1>
        ...
        <div className="space-y-6">
          {data.items.map((item, index) => (
            <div key={index} className="grid grid-cols-12 gap-4 items-center">
              ...
              <div className="col-span-2 text-right text-slate-900 font-medium">${item.amount.toFixed(2)}</div>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="w-80 space-y-4">
          ...
          <div className="border-t border-slate-900 pt-4">
            <div className="flex justify-between items-center">
              ...
              <span className="text-2xl font-light text-slate-900">${data.total.toFixed(2)}</span>
            </div>
          </div>
        </div>
      </div>
