  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 right-10 w-72 h-72 bg-gradient-to-r from-indigo-300/30 to-purple-300/30 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 left-10 w-64 h-64 bg-gradient-to-r from-purple-300/25 to-violet-300/25 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 right-1/2 w-96 h-96 bg-gradient-to-r from-cyan-200/20 to-blue-200/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      {/* Left side - Signup Form */}
        ...
        >
            ...
            <div className="text-center mb-10">
              ...
              >
                ...
                <p className="text-slate-600 text-xl leading-relaxed font-medium max-w-md mx-auto">
                  Create stunning professional invoices in minutes with our award-winning platform
                </p>
              </motion.div>
          ...
          {/* Ultra-Modern Google Sign Up Button */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          {/* Ultra-Modern Footer */}
            ...
            >
              ...
              <p className="text-slate-500 mt-6 leading-relaxed font-medium">
                ...
                <Link href="/terms" className="text-indigo-600 font-bold hover:underline transition-all duration-300">Terms of Service</Link>
                {' '}and{' '}
                <Link href="/privacy" className="text-indigo-600 font-bold hover:underline transition-all duration-300">Privacy Policy</Link>
              </p>
            </motion.div>
        </motion.div>
      </div>
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-xl text-slate-600 leading-relaxed font-medium">
                Join thousands of businesses creating stunning professional invoices with our award-winning platform
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="text-slate-600 font-semibold">User Rating</div>
              </motion.div>
              ...
              <motion.div
                ...
                className="p-6 rounded-[1.5rem] bg-white/60 backdrop-blur-2xl border border-white/40 shadow-2xl hover:shadow-3xl transition-all duration-500"
              >
                <Users className="h-10 w-10 text-blue-600 mb-4 mx-auto" />
              ...
              <motion.div
                ...
                className="p-6 rounded-[1.5rem] bg-white/60 backdrop-blur-2xl border border-white/40 shadow-2xl hover:shadow-3xl transition-all duration-500"
              >
                <Zap className="h-10 w-10 text-emerald-600 mb-4 mx-auto" />
                <div className="text-3xl font-black text-slate-900 mb-2">99.9%</div>
                <div className="text-slate-600 font-semibold">Uptime</div>
              </motion.div>
              ...
              <motion.div
                ...
                className="p-6 rounded-[1.5rem] bg-white/60 backdrop-blur-2xl border border-white/40 shadow-2xl hover:shadow-3xl transition-all duration-500"
              >
                <Crown className="h-10 w-10 text-indigo-600 mb-4 mx-auto" />
                <div className="text-3xl font-black text-slate-900 mb-2">3M</div>
                <div className="text-slate-600 font-semibold">Free Trial</div>
              </motion.div>
            </div>
