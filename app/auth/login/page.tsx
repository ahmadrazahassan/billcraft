            ...
            <div className="text-center mb-8">
              ...
              >
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  Sign in to continue creating professional invoices
                </p>
              </motion.div>
          </div>
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Welcome back to BillCraft. Your professional invoicing platform awaits.
          </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="text-2xl font-bold text-gray-900">Rated</div>
